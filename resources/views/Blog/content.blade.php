<x-layout>
    <main class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
        <div class="mt-8 flex flex-col justify-between col-span-12">
            <div class="pb-6 text-center">
                ...
                <div class="my-4">
                    <img src="/uploadedImages/{{$blog->image_name}}" alt="Blog illustration" class="w-full max-h-80 rounded-xl">
                </div>
            </div>
    ...
    <footer class="max-w-6xl mx-auto px-10 mb-10">
        <div class="mt-5 max-w-2xl mx-auto">
            ...
            <div class="relative mx-auto text-center px-4 py-2">
                ...
                @else
                    <span class="text-sm font-semibold">Login to post your comments</span>
                @endauth
            </div>
        </div>
    </footer>
